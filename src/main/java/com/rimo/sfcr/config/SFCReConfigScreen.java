...
public class SFCReConfigScreen {
    ...
    ConfigCategory gpu = builder.getOrCreateCategory(Text.translatable("text.sfcr.category.gpu"));
    ...
    private void buildCloudsCategory() {
        ...
        clouds.addEntry(entryBuilder
                .startDropdownMenu(Text.translatable("text.sfcr.option.cloudBlockSize")
                        , TopCellElementBuilder.of(config.getCloudBlockSize(), value -> {
    ...
    private void buildGpuCategory() {
        ...
        // noiseScaleXY
        gpu.addEntry(entryBuilder
                .startDoubleField(Text.translatable("text.sfcr.option.noiseScaleXY"),
                        config.getNoiseScaleXY())
                .setDefaultValue(0.05)
                .setMin(0)
                .setTooltip(Text.translatable("text.sfcr.option.noiseScaleXY.@Tooltip"))
                .setSaveConsumer(config::setNoiseScaleXY)
                .build());
        // noiseScaleZ
        gpu.addEntry(entryBuilder
                .startDoubleField(Text.translatable("text.sfcr.option.noiseScaleZ"),
                        config.getNoiseScaleZ())
                .setDefaultValue(0.05)
                .setMin(0)
        ...
        gpu.addEntry(entryBuilder
                .startDoubleField(Text.translatable("text.sfcr.option.cloudMoveSpeed"),
                        config.getCloudMoveSpeed())
                .setDefaultValue(0.01)
                .setMin(0)
                .setTooltip(Text.translatable("text.sfcr.option.cloudMoveSpeed.@Tooltip"))
        ...
        gpu.addEntry(entryBuilder
                ...
                .setDefaultValue(0)
                .setTooltip(Text.translatable("text.sfcr.option.cloudMoveDirection.@Tooltip"))
                .setTextGetter(v -> Text.of(((int) v) + "°"))
                .setSaveConsumer(config::setCloudMoveDirection)
                .build());
    }
